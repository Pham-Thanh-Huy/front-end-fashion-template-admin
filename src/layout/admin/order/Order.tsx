          ...
          <div className="card widget-flat">
            <div className="card-body p-0">
              <div className="p-3 pb-0">
                ...
                <h5 className="text-muted font-weight-normal mt-0">Total Sales</h5>
          ...
          <div className="card widget-flat">
            <div className="card-body p-0">
              <div className="p-3 pb-0">
                ...
                <h5 className="text-muted font-weight-normal mt-0">Income amounts</h5>
          ...
          <div className="card widget-flat">
            <div className="card-body p-0">
              <div className="p-3 pb-0">
                ...
                <h5 className="text-muted font-weight-normal mt-0">Total Users</h5>
          ...
          <div className="card widget-flat">
            <div className="card-body p-0">
              <div className="p-3 pb-0">
                ...
                <h5 className="text-muted font-weight-normal mt-0">Total Visits</h5>
