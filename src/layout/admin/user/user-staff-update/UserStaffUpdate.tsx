...
const UserStaffUpdate = () => {
    ...
    const onSubmit = (data: any) => {
        ...
        const confirm = window.confirm("Bạn có chắc chắn muốn Update người dùng này không");
        if (confirm) {
            let requestBody: any = {
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    {...register("username", {
                                        ...
                                        minLength: { value: 6, message: "Tên đăng nhập phải từ 6 ký tự trở lên" },
                                        maxLength: { value: 32, message: "Tên đăng nhậpkhông được quá 32 ký tự" },
                                    })}
                                />
                            ...
                            <div className="d-flex">
                                <div className="form-group mr-2">
                                    <label htmlFor="exampleInputEmail1" className="mr-2">Nam</label>
                                    <input
                                        type="radio"
                                        id="female"
                                        ...
                                        value={"M"}
                                        {...register('gender', { required: "Giới tính không được để trống" })}
                                        defaultChecked={user?.sex === "M"}
                                        onChange={() => setValue('gender', 'M')}
                                    />
                                </div>
                                <div className="form-group">
                                    <label htmlFor="exampleInputEmail1" className="mr-2">nữ</label>
                                    <input
                                        type="radio"
                                ...
                                <div style={{ color: 'red', marginBottom: '20px', marginLeft: '10px' }}>{errors.gender && <>{errors.gender?.message}</>}</div>
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    {...register("lastName", {
                                        ...
                                        minLength: { value: 2, message: "Họ phải từ 2 ký tự trở lên" }
                                    })}
                                />
                                <div style={{ color: 'red', marginBottom: '20px' }}>{errors.lastName && <>{errors.lastName?.message}</>}</div>
                            </div>
                            <div className="form-group">
                                <label htmlFor="exampleInputPassword1">
                                    Tên
                                ...
                                <input
                                    ...
                                    {...register("firstName", {
                                        ...
                                        minLength: { value: 2, message: "tên phải từ 2 ký tự trở lên" }
                                    })}
                                />
                                <div style={{ color: 'red', marginBottom: '20px' }}>{errors.firstName && <>{errors.firstName?.message}</>}</div>
                            </div>

                            <div style={{ color: 'red', marginBottom: '20px' }}>{errors.email && <>{errors.email?.message}</>}</div>
                            <div className="form-group">
                            ...
                            <div style={{ color: 'red', marginBottom: '20px' }}>{errors.age && <>{errors.age?.message}</>}</div>
                            <div className="form-group">
                                <label htmlFor="exampleInputPassword1">
                                    địa chỉ
                                </label>
                                <input
                                    ...
                                    {...register("address", { required: "Địa chỉ người dùng không được để trống" })}
                                />
                                <div style={{ color: 'red', marginBottom: '20px' }}>{errors.address && <>{errors.address?.message}</>}</div>
                            </div>
                            <div>
                                <label htmlFor="">
                                    Quyền của người dùng
                                </label>
                                <select className="form-control" {...register('authorize', { required: 'Quyền của người dùng không được để trống' })}>
                                    <option value="">Chọn</option>
                                    {authorizeList?.map((authorize: Authorize) => (
                                        <option value={authorize.authorizeId} selected={user?.authorizeList[0].authorizeId === authorize.authorizeId}>{authorize.authorizeName}</option>
                                    ))}
                                </select>
                                <div style={{ color: 'red', marginRight: '20px' }}>{errors.authorize && <>{errors.authorize.message}</>}</div>
                            </div>
                            <br />
                            <div style={{ color: 'red', marginRight: '20px' }}>{errors.password && <>{errors.password.message}</>}</div>
                            <br />
                            <div className="form-group row mb-0">
                                ...
                                <div className="col-lg-12">
                                    ...
                                    <div style={{ color: 'red', marginRight: '20px' }}>{errors.avatar && <>{errors.avatar.message}</>}</div>
                                    <div className="mt-2" id="selectedImage" />
                                    {avatar === null ? <div><img src={user?.imageUrl} /></div> : ''}
                                </div>
                            </div>
                            <br />
                            <br />
