    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            de.test(t.type) && t.click && D(t, "input") && Ne(t, "click", Ce),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            de.test(t.type) && t.click && D(t, "input") && Ne(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
  ...
  C.extend(C.event, {
    trigger: function (e, t, n, i) {
      ...
      if (
        ...
        if (!i && !c.noBubble && !b(n)) {
          for (
            a = c.delegateType || h, Et.test(a + h) || (o = o.parentNode);
            o;
            o = o.parentNode
          )
            d.push(o), (s = o);
      ...
      Ti = (function () {
        ...
        return (
          ...
          (e._activate = function (t) {
            ...
            n.hasClass(fi)
              ? (n.closest(yi).find(_i).addClass(di), n.addClass(di))
              : (n.addClass(di),
                n
                  .parents(pi)
                  .prev(gi + ", " + vi)
          ...
          this.each(function () {
            ...
            if (d.parent().hasClass(A.wrapperClass)) {
              ...
              y.css(_),
                ...
                T(),
                "bottom" === A.start
                  ? (b.css({ top: d.outerHeight() - b.outerHeight() }),
                    E(0, !0))
                  : "top" !== A.start &&
            ...
            function T() {
              (s = Math.max(
                (d.outerHeight() / d[0].scrollHeight) * d.outerHeight(),
                c,
              )),
                b.css({ height: s + "px" });
              ...
              e
                ...
                .on(c.CLICK_DATA_API, function (e) {
                  ...
                  if ("true" !== t.attr("aria-disabled")) {
                    ...
                    n.hasClass(f)
                      ? (t.attr("aria-expanded", "false"), o.removeActive(n))
          ...
          (e.show = function (e) {
            ...
            if (!this.transitioning && !a(e).hasClass(p)) {
              ...
              if ((n.trigger(i), !i.isDefaultPrevented())) {
                if (
                  (n.parent(this.config.parentTrigger).addClass(f),
                  this.config.toggle)
                ) {
                  var r = n
                    .parent(this.config.parentTrigger)
                    .siblings()
                    .children(this.config.subMenu + "." + d);
                  this.hide(r);
                }
